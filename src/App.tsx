...
import { SleepProvider } from './player/SleepProvider';
...
export function App() {
  ...
  return (
    <PlayerProvider>
      <GuardGate />
      {/* Inside PlayerProvider because the sleep timer's one action is a pause,
          and above the routes so its countdown survives navigation. */}
      <SleepProvider>
        <HistoryProvider>
          <div className="app">
            <main className="scroll">
